...
export const selectBillSuccess = createSelector(
  selectBillState,
  (state) => state.success
);
...
export const selectBillsOwner = createSelector(
  selectBillState,
  (state) => state.billsowner
);

export const selectBillsDetailOwner = createSelector(
  selectBillState,
  (state) => state.billdetailsowner
);
